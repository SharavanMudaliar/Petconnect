...
const yellowColorStyle = {
  color: "yellow", // Set text color to yellow
};
const FooterMenu = () => {
  const year = new Date();
  return (
    <Footer className="p-10 bg-blue-500 text-secondary-content mt-10">
      <article>
        <svg
          width="50"
          height="50"
        ...
        <p>
          <span style={yellowColorStyle}>Petconnect</span>
          <br />
          <span style={yellowColorStyle}>
            &copy; Sharavan Mudaliar- {year.getFullYear()}
          </span>
          <br />
          <a
            ...
            style={yellowColorStyle} // Apply yellow color to the link
          >
            Github
          </a>
        </p>
      ...
      <article>
        <Footer.Title style={{ fontWeight: "bold", color: "yellow" }}>
          Menu
        </Footer.Title>
        <Link to="/about" className="link link-hover" style={yellowColorStyle}>
          {" "}
          About
        </Link>
        <Link
        ...
        <Link to="/tips" className="link link-hover" style={yellowColorStyle}>
          {" "}
          Tips
        </Link>
        <Link
