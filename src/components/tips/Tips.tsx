  ...
  return (
    <PawHubContainer>
      ...
      <div className="text-center mt-8 text-yellow-700 ">
        ...
        <p>
          <ul>
            <li>
              <a
                rel="noreferrer"
                href="https://www.petfinder.com/dogs-and-puppies/"
              >
                {"Review your new pets history, background & special needs."}
              </a>
            </li>
            <li>
              <a rel="noreferrer" href="/pets">
                {"Choose your future pet compannion"}
              </a>
            </li>
            <li>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.veterinarians.com/"
              >
                {"Find a vet"}
              </a>
            </li>
            <li>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.hippo.com/blog/pet-proofing-your-home"
              >
            ...
            <li>
              ...
              >
                {
                  "Make a plan of action for introducing the new dog to your current pets"
                }
              </a>
            </li>
          </ul>
        ...
        <p>
          Because people find it hard to stay at home alone, a lot of people
          decided to adopt a friend .
        </p>
        <p className="font-bold">
          Petonnect wants to help you stay safe and help you find a friend you
          company during the pandemic. Check out the links below below for for
