...
export default function NotFound() {
  return (
    <PawHubContainer>
      <div className="flex h-[initial] flex-col md:flex-row w-full justify-center items-center lg:h-3/4 bg-blue-200 text-yellow-500">
        ...
        <div className="w-[100%] py-0 px-1 sm:w-[60%] lg:w-[30%] sm:my-0 sm:mx-auto lg:relative lg:ml-[8vw] lg:mt-[50px]">
          ...
          <ul className="[&>li]:mb-1 pl-2 list-[circle] mt-4 bg-blue-500 text-yellow-500">
            <li>
              <Link to="/" className="btn blue-500 text-yellow-500">
                HOME
              </Link>
            </li>
            <li>
              <Link to="/pets" className="btn blue-500 text-yellow-500">
                PETS
              </Link>
            </li>
            <li>
              <Link to="/resources" className="btn blue-500 text-yellow-500">
                RESOURCES
              </Link>
            </li>
            <li>
              <Link to="/tips" className="btn blue-500 text-yellow-500">
                TIPS
              </Link>
            </li>
            <li>
              <Link to="/donate" className="btn blue-500 text-yellow-500">
                DONATE
              </Link>
            </li>
          </ul>
